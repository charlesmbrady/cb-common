...
module.exports = {
  output: {
    path: join(__dirname, '../../dist/apps/mockdat-web'),
  },
  devServer: {
    port: 3000,
    historyApiFallback: {
  ...
  plugins: [
    new NxAppWebpackPlugin({
      ...
      baseHref: '/',
      // Keep general assets; config.json will be handled explicitly below
      assets: ['./src/assets'],
    ...
    // Detect Nx target configuration (e.g., 'test' or 'production')
